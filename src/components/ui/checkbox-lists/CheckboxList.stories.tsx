...
const CheckboxListWithState = () => {
	...
	const optionsSkills = [
		...
		{ title: 'Творчество и искусство', value: 'Творчество и искусство', className: '' },
		{ title: 'Иностранные языки', value: 'Иностранные языки', className: '' },
        { title: 'Образование и развитие', value: 'Образование и развитие', className: '' },
        { title: 'Здоровье и лайфстайл', value: 'Здоровье и лайфстайл', className: '' },
