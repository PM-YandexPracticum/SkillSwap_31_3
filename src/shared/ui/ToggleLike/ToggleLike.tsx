  ...
  return (
    <button className={`${styles.iconButton}`} onClick={handleClick}>
      {!checked ? (
        ...
        >
          <path
            d='M7.5 3C4.46244 3 2 5.46245 2 8.5C2 14 8.5 19 12 20.1631C15.5 19 22 14 22 8.5C22 5.46245 19.5375 3 16.5 3C14.6399 3 12.9954 3.92345 12 5.3369C11.0046 3.92345 9.36015 3 7.5 3Z'
